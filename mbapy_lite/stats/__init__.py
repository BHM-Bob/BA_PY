...
if __name__ == '__main__':
    ...
    from mbapy_lite.stats import cluster, df, geography, reg, test
else:
...
def max_pool2d(x:np.ndarray, pool_size:Tuple[int, int], stride: Tuple[int, int] = None):
    ...
    Raises:
        mbapy_lite inner error info: If pool_size does not have 2 dimensions.
        mbapy_lite inner error info: If stride is provided and does not have the same shape as pool_size.
