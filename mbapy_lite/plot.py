...
if __name__ == '__main__':
    ...
    from mbapy_lite.plot_utils.bar_utils import (AxisLable, plot_bar,
                                            plot_positional_hue, pro_bar_data)
    from mbapy_lite.plot_utils.line_utils import *
    from mbapy_lite.plot_utils.scatter_utils import (add_scatter_legend, plot_reg,
                                                plot_scatter)
    from mbapy_lite.stats.df import (get_df_data, pro_bar_data, pro_bar_data_R,
                                sort_df_factors)
    from mbapy_lite.stats.test import p_value_to_stars
else:
    # release mode
    # Assembly of functions
